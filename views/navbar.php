    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex-grow flex items-center justify-center">
        <a href="index.php" class="flex">
          <img src="src/images/yieldwerx.png" class="h-12 me-3" alt="YieldWerx Logo" />
        </a>
      </div>
      
      <!-- Right section (Optional if you have content here) -->
      ...
      <ul class="space-y-2 font-medium">
         <li>
            <a href="../index.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="ms-3">Selection Page</span>
            </a>
         </li>
      </ul>
   </div> -->
